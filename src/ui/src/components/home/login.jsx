...
export const ToolsContent = () => (
    <HelpPanel
        header={<h2>T360 Failover Demo</h2>}
        footer={
          <>
          </>
        }
    >
      <p>
        This solution demonstrates how to failover a sample T360 application across AWS regions.
      </p>
    </HelpPanel>
);
                  ...
                  <SpaceBetween size="xl">
                    ...
                    <Box variant="h3" fontWeight="bold">
                      <span className="text_white">
                        This solution demonstrates how to failover a sample application across AWS regions.
                      </span>
                    </Box>
                    <Box>
                      <Button disabled="true" href="/Remittances" variant="primary">Open Dashboard</Button>
                    </Box>
                  </SpaceBetween>
                </div>
